		...
		<div className="container">
			<nav className="navbar navbar-expand-md navbar-light">
				<div className="container-fluid">
					...
					{userRole === 'user' ? <Link className="nav-link" to="/mybooks">Мои книги</Link> : null}
					{userRole === 'admin' ? <Link className="nav-link" to="/usercontrol">Пользователи</Link> : null}
					{userRole === 'admin' ? <Link className="nav-link" to="/addbook">Добавить книгу</Link> : null}
